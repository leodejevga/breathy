    ...
    public void update(){
        ...
        switch ( plannedBreath ){
            case 1: punishProzent = Math.max( 0, punishProzent - 10 );
                break;
            case 2: punishProzent = Math.max( 0, punishProzent - 5 );
                break;
            case 3: punishProzent = Math.max( 0, punishProzent - 1 );
                break;
            case 4: punishProzent = Math.min( 0, punishProzent + 1 );
                break;
            case 5: punishProzent = Math.min( 0, punishProzent + 5 );
                break;
            case 6: punishProzent = Math.min( 0, punishProzent + 10 );
                break;
            default:
                return;
        }
