...
public class Line {
    ...
    public Line() {
        ...
        int vertexShader = Helper_Utils.compileShader(GLES20.GL_VERTEX_SHADER, VertexShaderCode);
        int fragmentShader = Helper_Utils.compileShader(GLES20.GL_FRAGMENT_SHADER, FragmentShaderCode);
    ...
    public void SetVerts(Vector point1, Vector point2) {
